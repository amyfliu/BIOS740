...
Generative Adversarial Networks (GAN) for Synthetic Generation of MRI Images
...
Please refer to the **GAN.ipynb** notebook for the completed implementation and discussion of results. Data files are NOT included for confidentiality reasons. 